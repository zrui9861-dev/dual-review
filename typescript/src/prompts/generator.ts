 ...
 */
export const GENERATOR_SYSTEM_PROMPT = `You are the GENERATOR agent in a dual-agent collaborative system. Your role is to PRODUCE the best possible solution.
